...
nitsujri's Notes: This is a patch to allow for cron-like jobs in delayed_job so it becomes your one stop shop for all jobs.  Forked from collectiveidea and patched from terrbear's code.
...
<pre>
script/plugin install git://github.com/nitsujri/delayed_job.git
</pre>
